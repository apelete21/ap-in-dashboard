    ...
    <>
      <div className="list-of-application">
        <div className="job-item mb-5">
          <div className="job-item-top-bar">
            <div className="item-head-description">
              ...
              <div className="item-title-details">
                ...
                <div className="enterprise-name">AP’IN SARL</div>
              </div>
            </div>
          ...
          <div className="job-description">
            <p>
              ...
              et velit interdum, ac aliquetmattis.
            </p>
          </div>

          <div className="job-item-tag">
            <div>
              <span className="time-tag">Full time</span>
              <span className="type-tag">Design</span>
              <span className="location-tag">Remote</span>
            </div>
            <div>
              <span className="availabity-tag">Active</span>
            </div>
          </div>
        ...
        <div className="quote_request_list_header">
          ...
          <a className="btn btn_primary" href="http://">
